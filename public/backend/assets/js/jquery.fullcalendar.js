!(function ($) {
    ...
    var CalendarApp = function () {
        ...
        (this.$modal = $("#event-modal")),
            ...
            (this.$events_data = $("#js_data_pass li"));
    ...
    (CalendarApp.prototype.onDrop = function (eventObj, date) {
        ...
        (CalendarApp.prototype.onEventClick = function (
            ...
            form.append(
                "<div class='input-group m-b-20'><input class='form-control' type=text value='" +
                    calEvent.title +
                    "' /><span class='input-group-append'><button type='submit' class='btn btn-primary'>Save</button></span></div>"
            );
            $this.$modal.modal({
                backdrop: "static",
            });
        ...
        (CalendarApp.prototype.onSelect = function (start, end, allDay) {
            ...
            form.find(".row")
                .append(
                    "<div class='col-md-6'><div class='form-group'><label>Event Name</label><input class='form-control' type='text' name='title'/></div></div>"
                )
                .append(
                    "<div class='col-md-6'><div class='form-group'><label>Category</label><select class='select form-control' name='category'></select></div></div>"
                )
    ...
    (CalendarApp.prototype.init = function () {
        ...
        var myArrayy = this.$events_data
            .map(function () {
                return [
                    {
                        title: $(this).find('.in_js_title').text(),
