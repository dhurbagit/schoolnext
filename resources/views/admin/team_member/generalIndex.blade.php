...
@section('pageTitle', 'Teacher and staff')
@section('content')
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify_and_align">
                    ...
                    <a href="{{ route('general.staff.create') }}" class="btn btn-success">Create New</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($t_list as $data)
                                <tr>
                                    ...
                                    <td>{{ Str::ucfirst($data->title) }}</td>
                                    <td>{{ Str::ucfirst($data->heading_one) }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('general.edit', $data->id) }}" class="btn btn-success">
