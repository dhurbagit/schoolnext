                    ...
                    <div class="top__header text-center">
                        ...
                        <div class="small__header">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis reiciendis
                                obcaecati harum totam maxime veritatis.</p>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="contact__form-holder wow fadeInDown" data-wow-delay="0.3s"
                                ...
                                <form action="{{route('contactus.save')}}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="Email Address" name="s_email"
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="Phone Number" name="s_phone"
                                                    aria-label="Recipient's username"
                                                    aria-describedby="basic-addon2">
                                                    <span class="text-danger">
                                                        @error('s_phone')
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control" placeholder="Address" name="s_address"
                                                    aria-label="Email" aria-describedby="basic-addon2">
                                                    <span class="text-danger">
                                                        @error('s_address')
                                                            {{$message}}
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <textarea class="form-control" id="exampleFormControlTextarea1" name="p_description"
